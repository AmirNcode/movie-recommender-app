...
type TasteEntry = { tmdbId: number; title: string; year: number; director: string; genre: string };
...
/** The four taste-profile list sections shared by both engine prompts. */
function tasteSectionsText(profile: TasteProfile): string {
